...
| `augustus_training_species` | The name of the species (a folder named like the name you choose and containing the augustus `species` profile will be created) e.g. `[ 'species1', 'species2' ]` |
