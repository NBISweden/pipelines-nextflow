process FILTER {
    ...
    script:
    """
    echo -e "Accession\\tUnique_matches\\tCoding_fraction\\tSpan_fraction" >> ${organelle}_statistics_summary.tsv
    ...
    do
        ...
        echo -e "\$line\\t\$unique_count\\t\$coding_fraction\\t\$span_fraction" >> ${organelle}_statistics_summary.tsv
