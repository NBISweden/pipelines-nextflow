process FILTER_BITSCORE_MITOCHONDRIA {
    ...
    script:
    """
    echo -e "Accession\\tUnique_matches\\tCoding_fraction\\tSpan_fraction" >> mitochondria_statistics_summary.tsv
    ...
    for line in \$LINES
    do
        grep \$line statistics_mitochondria.tsv | sort -k 9,9 -n > line_file.tsv
        ...
        echo -e "\$line\\t\$unique_count\\t\$coding_fraction\\t\$span_fraction" >> mitochondria_statistics_summary.tsv
