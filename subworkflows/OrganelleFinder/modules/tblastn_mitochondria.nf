process TBLASTN_MITOCHONDRIA {
    ...
    """
    tblastn -query $reference_organelle -db ${database} -evalue ${params.mit_blast_evalue} -outfmt "6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qlen slen" -out output_blast.tsv
    """
